...
![粘度释意图]({{ site.url }}/posts/20211201-2D Fuild/0.png)
### 平流 Advection
...
![向量场]({{ site.url }}/posts/20211201-2D Fuild/1.png)

衡量的是在某一点出相应的向量聚集或者发散程度，测量方向为径向，速度的散度如下：

![速度散度计算]({{ site.url }}/posts/20211201-2D Fuild/2.png)
...
![旋度]({{ site.url }}/posts/20211201-2D Fuild/3.png)

### 连续性方程

![]({{ site.url }}/posts/20211201-2D Fuild/4.png)
![]({{ site.url }}/posts/20211201-2D Fuild/5.png)

### 可压缩性

![]({{ site.url }}/posts/20211201-2D Fuild/6.png)

### 不可压缩流体

![]({{ site.url }}/posts/20211201-2D Fuild/7.png)
...
![]({{ site.url }}/posts/20211201-2D Fuild/8.png)

其中 $$\rho$$ 是（恒定）流体密度，$$\nu$$ 是运动粘度，$$F = (f_x, f_y)$$ 表示作用在流体上的任何外力。

![]({{ site.url }}/posts/20211201-2D Fuild/9.png)

Navier-Stokes 方程是二阶非线性偏微分方程，不易求解，故有一系列简化情况，其中一种简化如下文所推演。

**等式 2**

![]({{ site.url }}/posts/20211201-2D Fuild/10.png)

在假设流体是不可压缩的均质流体时，可得上式，进而简化方程。

![]({{ site.url }}/posts/20211201-2D Fuild/11.png)
...
![]({{ site.url }}/posts/20211201-2D Fuild/12.png)
...
![]({{ site.url }}/posts/20211201-2D Fuild/13.png)

的两边，我们得到：

![]({{ site.url }}/posts/20211201-2D Fuild/14.png)

由于**等式 2** ，这将简化为：

**等式 4**

![]({{ site.url }}/posts/20211201-2D Fuild/15.png)
...
![]({{ site.url }}/posts/20211201-2D Fuild/16.png)
...
![]({{ site.url }}/posts/20211201-2D Fuild/17.png)
...
![]({{ site.url }}/posts/20211201-2D Fuild/18.png)
...
![]({{ site.url }}/posts/20211201-2D Fuild/19.png)
...
![]({{ site.url }}/posts/20211201-2D Fuild/24.png)
...
![]({{ site.url }}/posts/20211201-2D Fuild/25.png)
...
![]({{ site.url }}/posts/20211201-2D Fuild/26.png)

其反溯过程如下图所示：

![]({{ site.url }}/posts/20211201-2D Fuild/27.png)
...
![]({{ site.url }}/posts/20211201-2D Fuild/28.png)

基于与平流计算类似的原因，我们采用隐式计算方式：

![]({{ site.url }}/posts/20211201-2D Fuild/29.png)
...
![]({{ site.url }}/posts/20211201-2D Fuild/30.png)

为了模拟流体如何携带染料，我们将平流算子应用于标量场，就像我们对速度所做的一样。如果我们还想考虑染料在流体中的扩散，我们添加一个扩散项：

![]({{ site.url }}/posts/20211201-2D Fuild/31.png)
